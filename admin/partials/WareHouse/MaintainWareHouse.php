                ...
                <div class="form-card mt-4 mb-4">
                    ...
                    <?php } else { ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12" hidden>
                                ...
                                <input type="text" value="<?php echo $Warehouse[0]->Id ?>" id="Id"
                                    class="form-control" >
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="inputqty" class="form-label">Name<span style="color: red;"> *</span></label>
                                <input required type="text" value="<?php echo $Warehouse[0]->Name ?>" id="Name"
                                    class="form-control" placeholder="Name">
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <label for="inputqty" class="form-label">Address</label>
                                <input type="text" id="Address" class="form-control" placeholder="Address"
                                    value="<?php echo $Warehouse[0]->Address ?>">
                            </div>
                            <div class="">
                                <div class="btn-layout">
            ...
            if (Obj.name != "") {
                if (action == 'Save') {
                    ...
                    $.ajax({
                        ...
                        url: ajaxurl,
                        data: {
                            'editwarehouse': JSON.stringify(Obj),
                            'action': 'admin_ajax_request' //this is the name of the AJAX method called in WordPress
                        }, success: function (result) {
                            window.location.href = "./admin.php?page=Warehouse-List"
                        },
